<h2><a href="https://leetcode.com/problems/check-if-bitwise-or-has-trailing-zeros/">2980. Check if Bitwise OR Has Trailing Zeros</a></h2><h3>Easy</h3><hr><div><p>You are given an array of <strong>positive</strong> integers <code>nums</code>.</p>
