...
https://youtu.be/tgVSkMA8joQ (as much as I love that approach and that video, you'll need to review the Leetcode Explore card below to find a better break down of the different Binary Search patterns)
