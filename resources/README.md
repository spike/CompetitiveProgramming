...
In our group, we all use different programming language, but if you don't know where to start, I'd suggest you start with Python and do all the problems on this site: https://pypup.com/
