...
In our meetup, we all use different programming languages, but if you don't know where to start, I'd suggest you start with Python and do all the problems on this site: https://pypup.com/
...
I recommend you try to do the Leetcode contests. The time pressure helps. And the randomness of the problems will help with your pattern-recognition. They're usually at 6:30 PM on Saturdays (Pacific Time).  
